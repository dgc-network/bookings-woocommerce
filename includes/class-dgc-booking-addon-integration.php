...
class WC_Product_dgc_booking_addon_integration {


	public function __construct(){

		//add_filter( 'woocommerce_product_addons_show_grand_total', array( $this, 'dgc_addon_hide_total' ), 20, 2 );
		add_filter('dgc_booking_cost',array($this,'dgc_apply_addon_price'),10,3);
	}


	public function dgc_addon_hide_total($show_total, $product){
		if ( $product->is_type( 'dgc_booking' ) ) {
			$show_total = false;
		}
		return $show_total;
	}

	public function dgc_apply_addon_price($booking_cost,$id) {
...
new WC_Product_dgc_booking_addon_integration();